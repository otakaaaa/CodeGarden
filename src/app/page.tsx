...
export default function HomePage() {
  return (
    <MainLayout>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-green-50 to-blue-50 py-20 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-6">
              組み立てながら学ぶ、
              <br />
              <span className="text-green-600">ノーコードの新しいカタチ</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
              <Button
                variant="secondary"
                size="lg"
                className="w-full sm:w-auto px-8 bg-white text-green-600 hover:bg-gray-100"
              >
                無料でアカウント作成
              </Button>
            </Link>
            <Link href="/pricing">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto px-8 border-white text-white hover:bg-white hover:text-green-600"
              >
                プランを比較する
              </Button>
            </Link>
